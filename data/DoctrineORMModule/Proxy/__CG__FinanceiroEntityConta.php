...
class Conta extends \Financeiro\Entity\Conta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Financeiro\\Entity\\Conta' . "\0" . 'id', '' . "\0" . 'Financeiro\\Entity\\Conta' . "\0" . 'descricao', '' . "\0" . 'Financeiro\\Entity\\Conta' . "\0" . 'saldo', '' . "\0" . 'Financeiro\\Entity\\Conta' . "\0" . 'user');
        }
