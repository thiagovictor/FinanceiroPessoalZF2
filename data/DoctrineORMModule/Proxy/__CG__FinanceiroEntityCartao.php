 ...
 */
class Cartao extends \Financeiro\Entity\Cartao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Financeiro\\Entity\\Cartao' . "\0" . 'id', '' . "\0" . 'Financeiro\\Entity\\Cartao' . "\0" . 'descricao', '' . "\0" . 'Financeiro\\Entity\\Cartao' . "\0" . 'vencimento', '' . "\0" . 'Financeiro\\Entity\\Cartao' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cartao $proxy) {
