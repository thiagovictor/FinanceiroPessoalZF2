 ...
 */
class Ativo extends \Financeiro\Entity\Ativo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Financeiro\\Entity\\Ativo' . "\0" . 'id', '' . "\0" . 'Financeiro\\Entity\\Ativo' . "\0" . 'nome', 'usuarios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ativo $proxy) {
