 ...
 */
class Tipo extends \Financeiro\Entity\Tipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Financeiro\\Entity\\Tipo' . "\0" . 'id', '' . "\0" . 'Financeiro\\Entity\\Tipo' . "\0" . 'descricao', '' . "\0" . 'Financeiro\\Entity\\Tipo' . "\0" . 'javascript');
        }
